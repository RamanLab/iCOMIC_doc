...
![ Figure 1: The figure below depicts the available pipelines supported by iCOMIC](https://github.com/anjanaanilkumar1289/iCOMIC_doc/blob/master/docs/screenshots/pipeline.png?raw=true)  
